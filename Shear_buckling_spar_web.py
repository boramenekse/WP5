...
#Desing philosophy 1
#Front
plt.plot(y_list, critical_shear_stress_forward_spar_list_1, '-', 'Tao_Crit')
plt.plot(y_list, shear_stress_LC_8_1_forward, '-', 'Tao_LC8')
plt.plot(y_list, shear_stress_LC_12_1_forward, '-', 'Tao_LC12')
plt.plot(y_list, shear_stress_LC_16_1_forward, '-', 'Tao_LC16')
plt.legend()
plt.xlabel('Span [m]')
