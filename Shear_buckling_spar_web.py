...
fig, (ax1, ax2) = plt.subplots(2, 1, sharex=True)
fig.subplots_adjust(hspace=0.05)
ax1.plot(y_list, critical_shear_stress_forward_spar_list_3, '-', label='Tau_Crit')
ax1.plot(y_list, shear_stress_LC_8_3_forward, '-', label='Tau_LC8')
ax1.plot(y_list, shear_stress_LC_12_3_forward, '-', label='Tau_LC12')
ax1.plot(y_list, shear_stress_LC_16_3_forward, '-', label='Tau_LC16')
plt.suptitle('Shear stress in the forward spar, philosophy 3')
...
ax1.set_ylim(critical_shear_stress_forward_spar_list_3[0] - 0.5 * (maximum - minimum + max(abs(minimum), abs(maximum))), critical_shear_stress_forward_spar_list_3[0] + 0.5 * (maximum - minimum + max(abs(minimum), abs(maximum))))  # outliers only
ax2.set_ylim(minimum - 0.5 * max(abs(minimum), abs(maximum)), maximum + 0.5 * max(abs(minimum), abs(maximum)))
ax1.spines.bottom.set_visible(False)
ax2.spines.top.set_visible(False)
ax1.xaxis.tick_top()
...
fig, (ax1, ax2) = plt.subplots(2, 1, sharex=True)
fig.subplots_adjust(hspace=0.05)
ax1.plot(y_list, critical_shear_stress_rear_spar_list_3, '-', label='Tau_Crit')
ax1.plot(y_list, shear_stress_LC_8_3_rear, '-', label='Tau_LC8')
ax1.plot(y_list, shear_stress_LC_12_3_rear, '-', label='Tau_LC12')
ax1.plot(y_list, shear_stress_LC_16_3_rear, '-', label='Tau_LC16')
plt.suptitle('Shear stress in the rear spar, philosophy 3')
...
ax1.set_ylim(critical_shear_stress_rear_spar_list_3[0] - 0.5 * (maximum - minimum + max(abs(minimum), abs(maximum))), critical_shear_stress_rear_spar_list_3[0] + 0.5 * (maximum - minimum + max(abs(minimum), abs(maximum))))  # outliers only
ax2.set_ylim(minimum - 0.5 * max(abs(minimum), abs(maximum)), maximum + 0.5 * max(abs(minimum), abs(maximum)))
ax1.spines.bottom.set_visible(False)
ax2.spines.top.set_visible(False)
ax1.xaxis.tick_top()
