...
for i in range(0, len(Span_y_x)):
    ...
    moment_of_inertia_x_span.append(Moi_x_wingbox_y)
...
Parameters, covariance = curve_fit(test_function, Span_y_x, moment_of_inertia_x_span)
...
Fit_y = test_function(Span_y_x, Fit_A, Fit_B, Fit_C, Fit_D)
#print('The values for A, B and C in the function Ax^3 + Bx^2 + Cx + D are:', Fit_A, Fit_B, Fit_C, Fit_D)

#Plotting the results 
#plt.plot(Span_y_x, moment_of_inertia_x_span, 'o', label='Data')
#plt.plot(Span_y_x, Fit_y, '-', label='Fit')
